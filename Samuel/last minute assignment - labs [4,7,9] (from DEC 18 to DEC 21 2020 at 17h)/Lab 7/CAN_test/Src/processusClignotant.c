...
//INCLUSIONS
#include "../Inc/main.h"
#include "../Inc/piloteCAN1.h"
#include "../Inc/serviceBaseDeTemps.h"
#include "../Inc/interfaceT1.h"
#include "../Inc/processusClignotant.h"
...
void processusClignotant_eteintUnPeu(void) {
    ...
    interfaceT1_allume();
    serviceBaseDeTemps_execute[PROCESSUSCLIGNOTANT_PHASE] = processusClignotant_allumeUnPeu;
    piloteCAN1_transmetDesDonnes(PILOTECAN1_IDENTIFICATION_EN_TRANSMISSION, processusClignotant_donneesATransmettre, 1);
...
void processusClignotant_allumeUnPeu(void) {
    ...
    processusClignotant_compteur = 0;
    interfaceT1_eteint();
    serviceBaseDeTemps_execute[PROCESSUSCLIGNOTANT_PHASE] = processusClignotant_eteintLongtemps;  
}
...
void processusClignotant_eteintLongtemps(void) {
    ...
    processusClignotant_compteur = 0;
    interfaceT1_allume();
    serviceBaseDeTemps_execute[PROCESSUSCLIGNOTANT_PHASE] = processusClignotant_allumeLongtemps;
}
...
void processusClignotant_allumeLongtemps(void) {
    ...
    processusClignotant_compteur = 0;
    interfaceT1_eteint();
    serviceBaseDeTemps_execute[PROCESSUSCLIGNOTANT_PHASE] = processusClignotant_eteintUnPeu;  
}
