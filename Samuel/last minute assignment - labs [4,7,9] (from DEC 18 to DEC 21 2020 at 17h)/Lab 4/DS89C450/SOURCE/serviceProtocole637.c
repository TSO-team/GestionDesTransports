...
#ifdef SERVICEPROTOCOLE637_DEBUG
  piloteUART0_transmet(serviceProtocole637.nombreATransmettre);
#endif
...
unsigned char donnee;
  ...
  piloteUART1_transmet(donnee);
#ifdef SERVICEPROTOCOLE637_DEBUG
  piloteUART0_transmet(donnee);
#endif
...
void serviceProtocole637_transmetUnZero(void)
{
  ...
  piloteUART1_transmet(SERVICEPROTOCOLE637_INSERTION);
 #ifdef SERVICEPROTOCOLE637_DEBUG
  piloteUART0_transmet(SERVICEPROTOCOLE637_INSERTION);
#endif 
  if(serviceProtocole637_compteurDeTransmissions == serviceProtocole637.nombreATransmettre)
  {
    serviceBaseDeTemps_execute[SERVICEPROTOCOLE637_PHASE_TRANSMISSION] =
...
#ifdef SERVICEPROTOCOLE637_DEBUG
  piloteUART0_transmet(serviceProtocole637_checksumDeTransmission);
#endif  
...
#ifdef SERVICEPROTOCOLE637_DEBUG  
  piloteUART0_transmet(serviceProtocole637_reception);      
#endif
